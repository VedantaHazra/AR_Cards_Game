...
app.post("/trade/:toAddress/:cardIdToTrade/:cardIdWanted", async (req, res) => {
  const { toAddress, cardIdToTrade, cardIdWanted } = req.params;
  console.log("req.params - ", toAddress, cardIdToTrade, cardIdWanted);
